return {
	...
	settings_preset = "SURVIVAL_TOGETHER", 			-- "SURVIVAL_TOGETHER", "MOD_MISSING", "SURVIVAL_TOGETHER_CLASSIC", "SURVIVAL_DEFAULT_PLUS", "COMPLETE_DARKNESS", "TERRARIA", "DST_CAVE", "DST_CAVE_PLUS", "TERRARIA_CAVE", "CUSTOM_CUSTOM PRESET 1"
	worldgen_preset = "SURVIVAL_TOGETHER", 			-- "SURVIVAL_TOGETHER", "MOD_MISSING", "SURVIVAL_TOGETHER_CLASSIC", "SURVIVAL_DEFAULT_PLUS", "COMPLETE_DARKNESS", "TERRARIA", "DST_CAVE", "DST_CAVE_PLUS", "TERRARIA_CAVE", "CUSTOM_CUSTOM PRESET 1"
	overrides = {
		--WORLDSETTINGS
		-- GLOBAL
		...
		flower_cave_regrowth = "fast", 			-- "never", "veryslow", "slow", "default", "fast", "veryfast"
		...
		-- PORTAL_RESOURCES
		bananabush_portalrate = "often", 			-- "never", "rare", "default", "often", "always"
		lightcrab_portalrate = "often", 			-- "never", "rare", "default", "often", "always"
		monkeytail_portalrate = "often", 			-- "never", "rare", "default", "often", "always"
		palmcone_seed_portalrate = "often", 			-- "never", "rare", "default", "often", "always"
		portal_spawnrate = "default", 			-- "never", "rare", "default", "often", "always"
		powder_monkey_portalrate = "often", 			-- "never", "rare", "default", "often", "always"

		-- ANIMALS
		bees_setting = "default", 			-- "never", "rare", "default", "often", "always"
		birds = "default", 			-- "never", "rare", "default", "often", "always"
		lightfliers = "often", 			-- "never", "rare", "default", "often", "always"
		...
		walrus_setting = "often", 			-- "never", "rare", "default", "often", "always"
		...
		boons = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		carrot = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		...
		flowers = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		wormlights = "default", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
		grass = "often", 			-- "never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
